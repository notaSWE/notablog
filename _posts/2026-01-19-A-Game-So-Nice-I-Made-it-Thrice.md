...
date: 2026-01-19 00:00:01 -0500
---

![Cube Boi]({{ site.baseurl }}/docs/assets/2026_01_20_cubeboi.jpg "Cube Boi Model")
...
<video controls playsinline preload="metadata" style="max-width:100%; height:auto;">
  <source src="{{ site.baseurl }}/docs/assets/2026_01_20_cubeboi.mp4" type="video/mp4">
...
![Cube Boi]({{ site.baseurl }}/docs/assets/2026_01_20_blender_armature.PNG "Armature")
...
![Cube Boi]({{ site.baseurl }}/docs/assets/2026_01_20_walk.gif "Walk Cycle")
...
- Import CubeBoi FBX/glb file with animation data
- Enable movement of the Cube Boi character with animations
- Create terrain based on Gaea output if possible
...
![Unity Project]({{ site.baseurl }}/docs/assets/2026_01_20_code_unity_coin.PNG "Unity C#")
...
![Unreal Project]({{ site.baseurl }}/docs/assets/2026_01_20_editor_unreal.PNG "Unreal Editor")
...
![Unreal Project]({{ site.baseurl }}/docs/assets/2026_01_20_code_unreal_coin.PNG "Unreal Blueprint")
...
![Unreal Project]({{ site.baseurl }}/docs/assets/2026_01_20_blueprint_unreal_camera_spaghetti.PNG "Unreal Blueprint 2")
...
![Godot Project]({{ site.baseurl }}/docs/assets/2026_01_20_editor_godot.PNG "Godot Editor")
...
![Godot Project]({{ site.baseurl }}/docs/assets/2026_01_20_cubeboi_godot_scene.PNG "Godot Cube Boi Scene")
...
- Which engine did I feel the most confident in?  **Unity**
- Which engine took the least amount of time to implement gameplay mechanics?  **Unity**
- Which engine benefits the most from LLM assistance?  **Unity w/ Cursor**
- Which engine looks the best graphically?  **Unreal**
- Which engine provided the best "game feel" for my game? **Godot**
- Which engine had the most intuitive animation state machine? **Tie**
- Which engine can deploy to the largest audience with the least amount of configuration? **Unity**
- If I spent the next month working on only one engine's version of Cube Boi, which one would likely be the most feature complete by end of development given all of the above?  **Unity**
